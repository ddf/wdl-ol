...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugQuartz-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugQuartz-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugQuartz-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugQuartz-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/IPlugQuartz-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/IPlugQuartz-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugQuartz-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugQuartz.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugQuartz.iss",inplace=1):
