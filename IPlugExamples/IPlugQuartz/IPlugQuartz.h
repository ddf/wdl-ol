...
/*
 ...
 IPlugQuartz - an IPlug project template that includes controls and features typically used in Damien Quartz's IPlugs.

*/

class IPlugQuartz : public IPlug
{
public:

	IPlugQuartz(IPlugInstanceInfo instanceInfo);
	~IPlugQuartz();
