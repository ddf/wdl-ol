...
bool ISysEx::IsMMC() const
{
	return mSize == 6 && mData[0] == 0xF0 && mData[1] == 0x7F;
}

int ISysEx::MMCDeviceId() const
{
	if (IsMMC())
	{
		return mData[2];
...
ISysEx::EMMCCommand ISysEx::MMCCommand() const
{
	if (IsMMC())
	{
		return (EMMCCommand)mData[4];
	}
	return kNone;
}
//////////////////////////////////////////////////////////////////////////
